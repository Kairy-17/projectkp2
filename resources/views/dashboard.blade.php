...
<main class="flex-1 flex flex-col h-screen overflow-hidden bg-gradient-to-br from-slate-50 to-indigo-50/30">
    <div class="flex-1 overflow-y-auto p-6 md:p-12 flex flex-col items-center justify-center">
        ...
        <div class="text-center mb-12">
            ...
            <h1 class="text-3xl md:text-4xl font-bold tracking-tight text-slate-900 mb-2">Welcome to ProTrack</h1>
            <p class="text-slate-500">Pilih modul yang ingin Anda buka hari ini.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">
            ...
            <a href="{{ route('projects.index') }}" class="glass p-8 md:p-10 rounded-3xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden border border-slate-200/60">
                ...
                <div class="relative z-10">
                    ...
                    <h2 class="text-2xl font-bold text-slate-800 mb-3 group-hover:text-indigo-600 transition-colors">Project Reminder</h2>
                    <p class="text-slate-500 mb-6 line-clamp-2">Pantau status, timeline, dan deadline dari seluruh proyek yang sedang berjalan.</p>
            ...
            <a href="{{ route('reports.index') }}" class="glass p-8 md:p-10 rounded-3xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden border border-slate-200/60">
                ...
                <div class="relative z-10">
                    ...
                    <h2 class="text-2xl font-bold text-slate-800 mb-3 group-hover:text-emerald-600 transition-colors">Laporan Kinerja</h2>
                    <p class="text-slate-500 mb-6 line-clamp-2">Lihat data finansial, margin, dan analisis performa dari setiap proyek.</p>
