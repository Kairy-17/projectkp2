<div class="relative group/notif inline-block text-left" x-data="{ open: false }">
    ...
    <div x-show="open" x-cloak style="display: none;" 
         class="absolute right-0 z-50 mt-2 w-[calc(100vw-2rem)] max-w-[320px] sm:max-w-none sm:w-80 origin-top-right rounded-xl bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none overflow-hidden">
